...
// 1. IMPORT ALL THREE PIECES OF DATA
...
export default function BranchClient({ slug }: { slug: string }) {
  ...
  // 2. NEW: Filter the master team list to find artists working at THIS branch!
  ...
  return (
    <div className="relative min-h-screen pt-32 pb-24 px-4 sm:px-6">
      ...
      <div className="max-w-7xl mx-auto relative z-10 space-y-24">
        ...
        {/* 3. FIX: Updated to use branchArtists instead of branch.artists */}
              ...
              {branchArtists.map((artist, index) => (
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 w-full p-6 sm:p-8 flex flex-col justify-end">
                    ...
                    {/* NEW: Clean Location Badge replacing Role/Rating */}
        ...
        {/* SECTION 3: Standard Branch Services */}
